...
Why use butterfly when there are so many other methods of comparing dataframes?

The short answer is that none of them **quite** fit what we were after. While we are comparing two dataframes for differences, with continually updating data we are actually expecting these to be different. A bit of wrangling is therefore required:
